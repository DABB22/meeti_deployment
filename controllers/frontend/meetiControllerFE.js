...
exports.confirmarAsistencia = async (req, res) => {
    ...
    if(accion === 'confirmar') {
        // agregar el usuario
        Meeti.update( // Sequelize.fn() te va a permitir utilizar una función
            {'interesados' :  Sequelize.fn('array_append', Sequelize.col('interesados'), req.user.id  ) }, // nombre de la tabla : Sequelize.fn(funcion a utilizar de postgres , qué columna, el id del usuario)
