...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(asistencia) {
        asistencia.addEventListener('submit', confirmarAsistencia); // como este es el formulario escucharemos por un submit
    }
...
function confirmarAsistencia(e) {
    ...
    // console.log(this) // this viene siendo el submit del formulario confirmar-asistencia
